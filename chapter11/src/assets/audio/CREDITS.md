...
Assets are licensed under **CC0** (public domain) or **CC-BY 3.0** (attribution required).
Both licenses allow commercial use and open-source distribution.
...
|------|--------|---------|-------------|
| `music/menu_ambient.mp3` | [Happy Adventure (Loop)](https://opengameart.org/content/happy-adventure-loop) — OpenGameArt.org | CC0 | None required |
| `music/battle_theme.ogg` | [Chiptune Battle Music](https://opengameart.org/content/chiptune-battle-music) — OpenGameArt.org | CC0 | None required |
...
| `sfx/death_player.mp3` | [Hurt / Death Sound Effect for Character](https://opengameart.org/content/hurt-death-sound-effect-for-character) — OpenGameArt.org | CC0 | None required |
